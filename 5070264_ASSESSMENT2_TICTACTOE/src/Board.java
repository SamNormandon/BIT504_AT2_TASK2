...
public class Board {
	...
	public Board() {
	 ...
	 this.cells = new Cell[GameMain.ROWS][GameMain.COLS]; // Initialize the cells array using ROWS and COLS constants 
	...
	public boolean isDraw() {
		for (int row = 0; row < GameMain.ROWS; ++ row) {		// nested loop to check whether the game has ended in a draw
		 ...
		 return true;		// return true if there are no empty positions left.
